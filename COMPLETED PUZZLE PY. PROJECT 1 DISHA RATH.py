...
knowledge2 = And(
    ...
    Imolication(AKnave, Not(Or(And(AKnight,BKnight),And(AKnave,BKnave)))),
    
)

# Puzzle 3
# A says either "I am knight." or "I am a knave.",but you don't know which.
